...
function homeReducer(state = initialState, action) {
  switch (action.type) {
    ...
    case GET_IP:
      return state
        .setIn(["getIPStatus", "loading"], true)
        .setIn(["getIPStatus", "loaded"], false)
        .setIn(["getIPStatus", "error"], false);
    case GET_IP_SUCCESS:
      return state
        .setIn(["getIPStatus", "loading"], false)
        .setIn(["getIPStatus", "loaded"], true)
        .setIn(["getIPStatus", "error"], false)
        .setIn(["ip"], fromJS(action.ip));
    case GET_IP_FAIL:
      return state
        .setIn(["getIPStatus", "loading"], false)
        .setIn(["getIPStatus", "loaded"], false)
        .setIn(["getIPStatus", "error"], action.error);
